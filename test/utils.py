...
class TestDataCreator:
    ...
    def create_test_data(self, compress: bool):
        ...
        csv1_dict: dict = {
            ...
            CSV1_NOMINAL_FEAT3_NAME: [
                CSV1_NOMINAL_FEAT3_VAL1, CSV1_NOMINAL_FEAT3_VAL2, float(NAN), CSV1_NOMINAL_FEAT3_VAL3,
                CSV1_NOMINAL_FEAT3_VAL3, CSV1_NOMINAL_FEAT3_VAL3
            ],
